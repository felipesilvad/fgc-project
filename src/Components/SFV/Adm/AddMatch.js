        ...
        <Row className="add-set" id="set2">
          ...
          <Col md={2}>
            ...
            <div>
              ...
              <div className="d-flex">
                <a>Char1</a>
                <input type="number" name="vt" onChange={e => setS2Char1Result(e.currentTarget.value)}
                  style={{width: '-webkit-fill-available'}}
                />
              </div>
              <div className="d-flex">
                <a>Char2</a><input type="number" name="vt" onChange={e => setS2Char2Result(e.currentTarget.value)}
                  style={{width: '-webkit-fill-available'}}
                />
              </div>
            </div>
